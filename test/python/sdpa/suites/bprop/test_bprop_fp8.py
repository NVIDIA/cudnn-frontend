...
@pytest.mark.L0
@pytest.mark.parametrize("test_no", suite_seeds("bprop.fp8.dense"), ids=lambda p: f"test{p[0]}")
...
@pytest.mark.L0
@pytest.mark.parametrize("test_no", suite_seeds("bprop.fp8.thd"), ids=lambda p: f"test{p[0]}")

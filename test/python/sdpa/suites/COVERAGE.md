...
| context.f16.chunked | f16 | L0 | 256 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, stats token/head-major, total_q/kv slack, declare totals on graph, ragged token gaps, layout ragged/cu_ragged/padded/full | infer, s_q<=1024 chunks, s_kv up to 16k | chunked prefill: query chunks against a long KV history (was generation.f16.thd_chunked) |
| context.fp8.chunked | fp8 | L0 | 192 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, e4m3/e5m2 in, out fp8/fp16, layout ragged/cu_ragged/padded/full, sink, capacity slack, declared totals | infer, s_q<=1024 chunks, s_kv up to 16k, d<=128 (fp8 ragged d>128 hangs the backend) | chunked prefill, fp8 (was generation.fp8.thd_chunked) |
...
**Total configs: 7360 across 57 suites.**

...
| context.f16.dense_chunked | f16 | L0 | 128 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, layout padded/cu_padded/full | infer, s_q<=1024 chunks, s_kv up to 16k | chunked prefill, dense: query chunks against a long KV history |
| context.f16.thd_chunked | f16 | L0 | 256 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, stats token/head-major, total_q/kv slack, declare totals on graph, ragged token gaps, layout ragged/cu_ragged | infer, s_q<=1024 chunks, s_kv up to 16k, layout THD | chunked prefill, packed THD: the serving shape |
...
| context.fp8.dense_chunked | fp8 | L0 | 128 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, e4m3/e5m2 in, out fp8/fp16, layout padded/full, sink | infer, s_q<=1024 chunks, s_kv up to 16k | chunked prefill, fp8 dense (d up to 192 — no ragged-hang envelope) |
| context.fp8.thd_chunked | fp8 | L0 | 192 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, e4m3/e5m2 in, out fp8/fp16, layout ragged/cu_ragged, sink, capacity slack, declared totals | infer, s_q<=1024 chunks, s_kv up to 16k, layout THD, d<=128 (fp8 ragged d>128 hangs the backend) | chunked prefill, fp8 packed THD |

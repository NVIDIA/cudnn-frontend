...
| bprop.fp8.thd | fp8 | L0 | 256 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, out fp8/fp16, deterministic, sink, total_q/kv slack | train, e4m3 in, no mask, diag TL, layout THD (ragged) | cuDNN>=92101; ragged FP8 backward requires cuDNN > 9.21.0 |

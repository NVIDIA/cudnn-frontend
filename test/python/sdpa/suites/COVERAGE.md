...
| context.fp8.thd | fp8 | L0 | 128 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, e4m3/e5m2 in, out fp8/fp16, layout ragged/cu_ragged/cu_ragged_mult, total_q/kv slack, declare totals on graph, rescale 0/2/4 (SM100) | infer, no mask, diag TL |  |
| context.mxfp8.dense | mxfp8 | L0 | 384 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, e4m3/e5m2 in, out fp16/bf16, layout padded/full, sink, unfuse_fma, rescale 0/2/4 (SM100) | infer, impl AUTO, SM100+ | SM>=100 |
...
**Total configs: 3696 across 64 suites.**

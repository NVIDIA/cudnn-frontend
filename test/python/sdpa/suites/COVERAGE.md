...
| context.fp16.thd | fp16 | L0 | 64 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, stats token/head-major, total_q/kv slack, declare totals on graph, ragged token gaps, sink | infer, layout THD (ragged), impl AUTO |  |
| context.bf16.thd | bf16 | L0 | 64 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, stats token/head-major, total_q/kv slack, declare totals on graph, ragged token gaps, sink | infer, layout THD (ragged), impl AUTO |  |
| context.fp16.thd_unified | fp16 | L1 | 64 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, stats token/head-major, total_q/kv slack, declare totals on graph, ragged token gaps, layout ragged/cu_ragged, sink | infer, no mask, diag TL, impl UNIFIED |  |
| context.fp16.thd_offset_mult | fp16 | L1 | 64 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, stats token/head-major, total_q/kv slack, declare totals on graph, ragged token gaps, layout ragged_mult/cu_ragged_mult, sink | infer, no mask, diag TL, impl UNIFIED | cuDNN>=92400; ragged offset multiplier: unified fwd engine only, cuDNN >= 9.24 |
| context.fp8.dense | fp8 | L0 | 256 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, e4m3/e5m2 in, out fp8/fp16, layout padded/full, sink, unfuse_fma, rescale 0/2/4 (SM100) | infer, impl AUTO |  |
| context.fp8.thd | fp8 | L0 | 32 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, e4m3/e5m2 in, out fp8/fp16, layout ragged/cu_ragged/cu_ragged_mult, total_q/kv slack, declare totals on graph, rescale 0/2/4 (SM100) | infer, no mask, diag TL |  |
| context.mxfp8.dense | mxfp8 | L0 | 256 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, e4m3/e5m2 in, out fp16/bf16, layout padded/full, sink, unfuse_fma, rescale 0/2/4 (SM100) | infer, impl AUTO, SM100+ | SM>=100 |
...
| generation.fp8.decode | fp8 | L0 | 32 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, e4m3/e5m2 in, out fp8/fp16, diag TL/BR, unfuse_fma, rescale 0/2/4 (SM100) | infer, s_q=1, no mask, layout full |  |
| generation.fp8.paged | fp8 | L0 | 32 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, e4m3/e5m2 in, out fp8/fp16, block size 16..128, rescale 0/2/4 (SM100) | infer, no mask, diag TL, layout padded, paged KV |  |
...
| bprop.fp16.thd | fp16 | L0 | 128 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, stats token/head-major, total_q/kv slack, declare totals on graph, ragged token gaps, deterministic, sink | train, layout THD (ragged), impl AUTO |  |
| bprop.bf16.thd | bf16 | L0 | 128 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, mask: causal/left/right/band/none, diag TL/BR, stats token/head-major, total_q/kv slack, declare totals on graph, ragged token gaps, deterministic, sink | train, layout THD (ragged), impl AUTO |  |
...
| bprop.fp8.thd | fp8 | L0 | 32 | batch, s_q/s_kv, d_qk/d_v, heads (MHA/GQA/MQA), strides+gaps, data, out fp8/fp16, deterministic, sink, total_q/kv slack | train, e4m3 in, no mask, diag TL, layout THD (ragged), rescale off | cuDNN>=92101; ragged FP8 backward requires cuDNN > 9.21.0 |
...
**Total configs: 3184 across 64 suites.**

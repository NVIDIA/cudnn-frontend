...
from gnn._mha_test_utils import _require_gnn_mha, _reference_gat_v2, _tolerances, graph_data
...
def test_gnn_mha_gat_v2_forward_backward(graph_data, dtype, concat_heads, with_edge, deterministic):

    ...
    def kernel(
            ...
            while is_valid_tile:
                ...
                if cutlass.const_expr(self.generate_sfd):
                    ...
                    if cutlass.const_expr(self.enable_breuse):
                        ...
                        bSG_sD_col, bSG_gD_col_partitioned = self.epilog_gmem_copy_and_partition(epi_tidx, tma_atom_d_col, tCgD_col_loop, epi_tile, sD_col)
                    bSG_gD_col = bSG_gD_col_partitioned[(None, None, None, mma_tile_coord_mnl[0], mma_tile_coord_mnl[1], 0)]
        ...
        if warp_idx == self.epilog_load_tma_id:
            ...
            while is_valid_tile:
                ...
                bGS_sC, bGS_gC_partitioned_bk = self.epilog_gmem_copy_and_partition(tidx, tma_atom_c, tCgC_loop, epi_tile, sC)
                bGS_gC_bk = bGS_gC_partitioned_bk[(None, None, None, mma_tile_coord_mnl[0], mma_tile_coord_mnl[1], 0)]
                ...
                if cutlass.const_expr(self.enable_breuse):
                    ...
                    bGS_gC_br = bGS_gC_partitioned_br[(None, None, None, mma_tile_coord_mnl[0], mma_tile_coord_mnl[1], 0)]

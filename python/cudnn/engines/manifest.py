...
MANIFEST: Tuple[EngineFamily, ...] = (
    ...
    EngineFamily(
        ...
        slots={
            ...
            # 17 sm89 d64 (Ada / L20).  Appended, never reordered: slots are
            # identity, so an id that ever shipped keeps its meaning.
            "sdpa_fwd_prefill_sm89": EngineSlot(17, opt_in=True),
        },

...
class VariantPack:
    ...
    declaration keeps its own description. Reordered scale blobs retain their
    physical extents for the engine's capacity checks. A described slot carries the

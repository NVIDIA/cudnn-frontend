...
_OPERATION_EXPORTS = {
    ...
    "gemm_swiglu_wrapper": ("..gemm_swiglu.jax", "gemm_swiglu_wrapper"),
...
_DSA_EXPORTS = frozenset(name for name, (module_name, _) in _OPERATION_EXPORTS.items() if module_name.startswith("..deepseek_sparse_attention."))

...
def _prepare_fc1(
    ...
    *,
    ...
    payload_interleaved = payload_nkh if already_interleaved else _interleave_gate_up_rows(payload_nkh, intermediate)
    ...
    scales_interleaved = scales_nk if already_interleaved else _interleave_gate_up_rows(scales_nk, intermediate)

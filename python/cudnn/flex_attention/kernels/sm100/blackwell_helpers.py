...
def declare_ptx_smem_desc(
    ...
    tCrA_layout = (
        tCrA_layout
        if const_expr(not is_ts)
        # Supported TMEM operands are FP16/BF16.
...
def gemm_ptx_precomputed_varname(
    ...
    llvm.inline_asm(
        ...
        + f"@leader_thread tcgen05.mma.cta_group::{cta_group}.kind::f16 [tmem_acc], {smem_var_name_prefix}_0, smem_desc_b_0, {idesc_var_name}, 0;\n\t"
        + "".join(

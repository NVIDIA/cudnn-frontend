...
from ..fwd.kernels import sdpa_config_dsv3, sdpa_config_gptoss, sdpa_config_llama, sdpa_config_qwen

_FLAVOR_DIMS = {
    name: (cfg.D_QK, cfg.D_V)
    for name, cfg in (
        ("gptoss", sdpa_config_gptoss.CFG),
        ("llama", sdpa_config_llama.CFG),
        ("dsv3", sdpa_config_dsv3.CFG),
        ("qwen", sdpa_config_qwen.CFG),
    )
}

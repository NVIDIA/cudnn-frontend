...
_LAZY_EXPORTS = {
    "SdpafwdSm100D256": (".api", "SdpafwdSm100D256"),
    "sdpa_fwd_wrapper_sm100_d256": (".api", "sdpa_fwd_wrapper_sm100_d256"),
    ...
    "SdpafwdSm80": (".api_sm80", "SdpafwdSm80"),
    "sdpa_fwd_wrapper_sm80": (".api_sm80", "sdpa_fwd_wrapper_sm80"),
}

...
SM120 family (SM120 and SM121) using TMA K/V loads — the d256 flavor.
...
- Runtime head dimensions must lie in the flavor envelope, (256 - granule, 256] on both
  sides (multiples of 8; ``config_sm120.D256_F16_CFG``)

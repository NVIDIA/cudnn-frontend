...
def make_sdpa_helpers(
    ...
    def _resolve_seqlen_kv(seq_kv_lens_tensor, batch_idx, scalar_seqlen_kv):
        ...
        if cutlass.const_expr(CFG.SEQ_KV_LENS_PRESENT == 1):
            ...
            # batch_idx may be a raw arith value after a payload read
            return cute.math.max(cutlass.Int32(0), cute.math.min(cutlass.Int32(arr[cutlass.Int32(batch_idx)]), scalar_seqlen_kv))

...
def _host(
    ...
    v_sf_groups = kv_sf_batches * KH * kv_sf_num_tiles
...
def compile(  # noqa: A001
    ...
    if PAGED_KV:
        ...
        fake_v = cute.runtime.make_fake_tensor(STORAGE_DTYPE, (n_pages, PAGE_SIZE, kh, CFG.TILE_O), tuple(v_stride), assumed_align=16)

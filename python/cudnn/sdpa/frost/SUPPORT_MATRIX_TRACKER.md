...
Amax_O is reset and unscaled on the launch stream. Quantized outputs, other FP8
flavors, MXFP8, synthesized KV-tail padding, bias and SM120 remain tensor-only and decline overrides;

...
_LAZY_OPTIONAL_IMPORTS = {
    ...
    "block_sparse_attention_forward_jax": (".block_sparse_attention", "block_sparse_attention_forward_jax"),
    "block_sparse_attention_backward_jax": (".block_sparse_attention", "block_sparse_attention_backward_jax"),
    "block_sparse_attention_jax": (".block_sparse_attention", "block_sparse_attention_jax"),
    ...
    "grouped_gemm_swiglu_jax_sm100": (".gemm.cutedsl.grouped", "grouped_gemm_swiglu_jax_sm100"),
    "grouped_gemm_dswiglu_jax_sm100": (".gemm.cutedsl.grouped", "grouped_gemm_dswiglu_jax_sm100"),

...
_LAZY_OPTIONAL_IMPORTS = {
    ...
    "HSTULMSDFwdSm100": (".hstu_lmsd", "HSTULMSDFwdSm100"),
    "HSTULMSDBwdSm100": (".hstu_lmsd", "HSTULMSDBwdSm100"),
    "hstu_lmsd_forward": (".hstu_lmsd", "hstu_lmsd_forward"),
    "hstu_lmsd_backward": (".hstu_lmsd", "hstu_lmsd_backward"),

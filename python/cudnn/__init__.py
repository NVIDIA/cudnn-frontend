...
_LAZY_OPTIONAL_IMPORTS = {
    ...
    "HSTUFwdSm100": (".hstu.hstu_attention", "HSTUFwdSm100"),
    "HSTUBwdSm100": (".hstu.hstu_attention", "HSTUBwdSm100"),
    ...
    "HSTULMSDFwdSm100": (".hstu.hstu_lmsd", "HSTULMSDFwdSm100"),
    "HSTULMSDBwdSm100": (".hstu.hstu_lmsd", "HSTULMSDBwdSm100"),

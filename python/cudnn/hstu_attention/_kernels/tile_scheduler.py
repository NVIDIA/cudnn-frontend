...
class StaticPersistentTileScheduler:
    ...
    def get_current_work(self, *, loc=None, ip=None) -> cutlass.utils.WorkTileInfo:
        ...
        return cutlass.utils.WorkTileInfo((Int32(block_idx), Int32(head_idx), Int32(batch_idx)), is_valid)
...
class SingleTileLPTScheduler:
    ...
    class Params(ParamsBase):
        ...
        @staticmethod
        @cute.jit
        def create(args: TileSchedulerArguments, *, loc=None, ip=None) -> "SingleTileLPTScheduler.Params":
            ...
            return SingleTileLPTScheduler.Params(
                ...
                l2_minor_residual_divmod=FastDivmod.create(max(num_hb_remainder, 1)),  # don't divide by 0

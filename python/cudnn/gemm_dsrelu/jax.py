...
class GemmDsreluSm100(ApiBaseJax):
    ...
    def __init__(
        ...
        *,
        ...
        self.c_desc = self.make_tensor_desc(
            sample_c,
            tensor_spec=gemm_c_tensor_spec(d_layout, name="d_layout"),
            name="sample_c",
        )
    ...
    def _check_support(self) -> None:
        ...
        self.c_dtype = self.require_dtype(self.c_desc, supported_outputs)
        ...
        require_16_byte_extent("sample_c", self.c_desc.shape[self.c_desc.stride_order[0]], self.c_dtype)

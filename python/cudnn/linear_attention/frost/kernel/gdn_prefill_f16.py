...
def prologue(
    ...
    o_box = bt if cutlass.const_expr(expand_num == 1) else cutlass.const_expr(-(-bt // expand_num))
    o_box_tail = bt if cutlass.const_expr(expand_num == 1) else cutlass.const_expr(bt // expand_num)

...
# Everything below needs PyTorch. Guarding the entire body in ONE top-level
# block keeps this module importable without PyTorch, and -- because Python
# caches modules -- guarantees the operator schemas, fake implementations,
# compiler hooks and autograd formulas below are registered exactly once when
# PyTorch IS present. Operator names and callable signatures are unchanged.

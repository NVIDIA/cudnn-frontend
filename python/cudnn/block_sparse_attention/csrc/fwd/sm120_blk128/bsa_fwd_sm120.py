...
from cudnn.block_sparse_attention.csrc.utils.batched_static_scheduler import BatchedStaticSchedulerMixin

SM120_BLK128_FWD_BLOCK_SIZE = 128


# =============================================================================
# Public kernel class
# =============================================================================
class BlockSparseAttnForwardSm120Blk128(BatchedStaticSchedulerMixin):
    """Native 128x128 SM120 sparse attention forward kernel.

    Each CTA consumes one logical blk128 metadata row directly and computes a
    full 128-query by 128-key tile with eight warp-level MMA partitions.
    """
    ...
    def kernel(
        ...
        # TMA load barriers for the single-stage Q/K/V buffers.

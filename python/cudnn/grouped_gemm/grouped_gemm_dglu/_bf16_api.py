...
def _get_output_dtypes():
    ...
    torch = torch_dep.require("cudnn.grouped_gemm.grouped_gemm_dglu._bf16_api")
...
class GroupedGemmDgluBf16API(APIBase):
    ...
    def __init__(
        ...
        torch = torch_dep.require("cudnn.grouped_gemm.grouped_gemm_dglu._bf16_api.__init__")
    ...
    def _record_pointer_stream(b_ptrs: torch.Tensor, stream: cuda.CUstream) -> None:
        torch = torch_dep.require("cudnn.grouped_gemm.grouped_gemm_dglu._bf16_api._record_pointer_stream")
        handle = int(stream)
    ...
    def check_support(self) -> bool:
        torch = torch_dep.require("cudnn.grouped_gemm.grouped_gemm_dglu._bf16_api.check_support")
        ...
        self._check_dtype(self.d_row_desc, _get_output_dtypes(), "sample_d_row")
    ...
    def compile(self) -> None:
        torch = torch_dep.require("cudnn.grouped_gemm.grouped_gemm_dglu._bf16_api.compile")

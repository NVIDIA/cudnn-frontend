...
class GroupedGemmDswigluSm100(APIBase):
    ...
    def __init__(
        ...
        """
        torch = torch_dep.require("cudnn.grouped_gemm.grouped_gemm_dswiglu.api.__init__")
    ...
    def check_support(self) -> bool:
        ...
        """
        torch = torch_dep.require("cudnn.grouped_gemm.grouped_gemm_dswiglu.api.check_support")
...
def grouped_gemm_dswiglu_wrapper_sm100(
    ...
    """
    torch = torch_dep.require("cudnn.grouped_gemm.grouped_gemm_dswiglu.api.grouped_gemm_dswiglu_wrapper_sm100")
    if acc_dtype is None:
        acc_dtype = torch.float32
    if d_dtype is None:

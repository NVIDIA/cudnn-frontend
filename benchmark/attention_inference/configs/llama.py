...
"""Llama 3.x-style GQA attention (d=128), inference phases.

Swept across tensor-parallel shards (TP 1/2/4/8 -> 64/8, 32/4, 16/2, 8/1
heads): the TP>1 presets are the shapes a single device actually executes at
high concurrency.
"""
...
CONFIG = InferenceBenchmarkConfig(
    name="llama3.1",
    models=with_tp_shards(LLAMA3_1, [1, 2, 4, 8]),

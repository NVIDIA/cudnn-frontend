...
**3. Licensing**. If the distribution terms in this Agreement are not suitable for your organization, or for any questions regarding this Agreement, please contact NVIDIA at [nvidia-compute-license-questions@nvidia.com](mailto:nvidia-compute-license-questions@nvidia.com).

...
![ConvolutionBwdData Engine](../images/convolutionBwData.webp)
...
![ConvolutionBwdFilter Engine](../images/convolutionBwFilter.webp)
...
![ConvolutionBwdFilter Engine](../images/convolutionFwd.webp)
...
![Graphical Representation of the Generic Patterns Supported by the Runtime Fusion Engines](../images/diagrams.webp)
...
![Values in the Index Tensors](../images/value-input-tensor.webp)
...
![Runtime Fusion Engines with a Single Operation](../images/example_conv.webp)
...
![ConvolutionFwd Followed by a DAG with Two Operations](../images/example_conv_pw.webp)
...
![ConvolutionFwd Followed by a DAG with Three Operations](../images/mxnet.webp)
...
![Matmul Preceded by a DAG with Two Operations](../images/matmul.webp)
...
![Fusion of Operations Before and After the `ConvolutionFwd` operation. In addition, we Observe that the Output of `ConvolutionFwd` can Feed Anywhere in g<sub>2</sub>.](../images/conv_DAG.webp)
...
![Mixed Precision matmul](../images/matmul-pointwise.webp)
...
![NormalizationForward Engine](../images/normalizationForward.webp)
...
![NormalizationBackward Engine](../images/normalizationBackward.webp)
...
![NormAddRelu cuDNN Operation Graph](../images/bnaddrelu.webp)
...
![Single Node Multi-GPU Batch Norm](../images/multi-gpu-batch-norm.webp)
...
![DReluForkDNorm cuDNN Operation Graph](../images/dreluforkdnorm.webp)
...
![Snapshot of support of Fused Flash Attention `fprop`](../images/fprop-ops.webp)
...
![Flash `fprop` Causal Mask Operation Graph](../images/fprop-causal-mask.webp)

**Padding Mask**

![Flash `fprop` Padding Mask Operation Graph](../images/fprop-padding-mask.webp)

**Sliding Window Mask**

![Flash `fprop` Sliding Window Mask Operation Graph](../images/sliding-window-mask.webp)

**Alibi Mask**

![Flash `fprop` Alibi Mask Operation Graph](../images/alibi-mask.webp)

**Softmax**

![Flash fprop Softmax Operation Graph](../images/fprop-softmax.webp)

**Dropout**

![Flash fprop Dropout Operation Graph](../images/fprop-dropout.webp)

**Paged KV caches**

![Flash fprop Paged Attention Operation Graph](../images/fprop-paged-kv.webp)
...
![FP8 Flash fprop Operation Graph](../images/fprop-tensor-datatypes.webp)
...
![Flash bprop cuDNN Operation Graph](../images/bprop-op-graph.webp)
...
![FP8 Flash bprop Operation Graph](../images/bprop-datatypes.webp)
...
![ConvBNfprop, A Pre-Compiled Engine, Fuses ConvolutionFwd and GenStats With Several Pointwise Operations](../images/ConvBNfprop.webp)
...
![DBARCS In The convBNfprop Series For Supporting Fusions Across Skip Connections](../images/new-pattern.webp)
...
![ConvBNwgrad, A Pre-Compiled Engine, Fuses ConvolutionBwdFilter With Several (Optional) Pointwise Operations](../images/ConvBNwgrad.webp)
...
![ConvBiasAct, A Pre-Compiled Engine, Fuses ConvolutionFwd With Several Pointwise Operations](../images/ConvBiasAct.webp)
...
![ConvScaleBiasAct, A Pre-Compiled Engine](../images/ConvScaleBiasAct.webp)
...
![DgradDreluBNBwdWeight Pattern For Fusions In The Backward Pass](../images/DgradDreluBnBwdWeight.webp)
...
![dBNApply Pattern For Final Gradient Computation](../images/DgradStandaloneSingleBNApplyMatcher.webp)
